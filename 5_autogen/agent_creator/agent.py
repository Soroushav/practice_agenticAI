...
class Agent(RoutedAgent):
    ...
    async def handle_message(self, message: messages.Message, ctx: MessageContext) -> messages.Message:
        ...
        if random.random() < self.CHANCES_THAT_I_BOUNCE_IDEA_OFF_ANOTHER:
            ...
            text = f"Here is my business idea. It may not be your speciality, but please refine it and make it better. {idea}"
            response = await self.send_message(message=messages.Message(content=text), recipient=recipient)
